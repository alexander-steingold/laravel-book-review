...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .filter-item {
            @apply flex w-full items-center justify-center rounded-md  py-2 text-center text-sm font-medium text-slate-500;
        }
...
<body class="container mx-auto mt-10 mb-10 max-w-5xl">
@yield('content')
</body>
